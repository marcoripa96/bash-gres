          ...
          <table className="w-full text-sm">
            ...
            <tbody className="text-muted-foreground">
              ...
              <tr className="border-b border-border/30">
                ...
                <td className="py-2">Version label this instance reads from and writes to inside its active version root. See <a href="/docs/versioning" className="underline underline-offset-2 hover:text-foreground transition-colors">Versioning</a>.</td>
              </tr>
              <tr className="border-b border-border/30">
